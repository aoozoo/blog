...
> 注：两个容器只在cpu0上运行，说明cpu绑定限制成功。而docker20是docker10使用cpu的2倍。说明–cpu-shares限制资源成功。

![在这里插入图片描述](https://img-blog.csdnimg.cn/0dcfaa1d85ba4a2a9f4070b3f8941ab3.png)
...
注：也可以使用stress进行测试，到现在，我可以限制docker实例使用cpu的核心数和权重，可以限制内存大小。

![在这里插入图片描述](https://imgs.ilee.xyz/img/ed40e16c8c5a4e13b4861521bccf2d9a.png)
...
![在这里插入图片描述](https://imgs.ilee.xyz/img/72c70a9e235149018c8df928666e687a.png)
